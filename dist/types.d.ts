export declare type NstackConfigDef = {
...
export declare type LanguageDef = {
    id: number;
    name: string;
    locale: string;
    direction: string;
...
export declare type LocalizeMetaDef = {
    id: number;
    url: string;
...
export declare type LocalizeDataDef = {
    [key: string]: {
        [key: string]: string;
    };
};
export declare type NstackOpenBodyDef = {
    /** Current version of app, format: xxx.yyy.zzz eg: 2.0.0 / 212.01.1 */
    version?: string;
    /** eg: ios/android/web (Default is web) */
    platform?: "web" | "ios" | "android";
